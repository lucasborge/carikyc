        ...
        <div class="container">
            <div class="row approve-container">
                <div class="col-md-12 approve-title">
                    <h2>Client <u>Not</u> Approved Acces to private Records</h2>
                    <h4>Client is 50% Verified via Public Records</h4>
                </div>
                <div class="col-md-12 approve-form">
                    <form role="form">
                        ...
                        <div class="col-md-12 form-group approve-next-btn">
                            <a href="/user/unapprove2"><span class="glyphicon glyphicon-arrow-right"></span></a>
                        </div>
                    </form>
                </div>
            </div>
